...
. Instead of printing out Brainfuck code, print out code in a different language (say, Java or C#). Pick a name for your class.

For example, in Java:

----
./brainfuck.exe echo.bf > mumble.java
javac mumble.java
java Default
----
