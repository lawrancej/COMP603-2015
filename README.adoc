...
http://en.wikipedia.org/wiki/Comparison_of_parser_generators[There are many of them]. Here's one for Java.

A tool that takes a grammar specification in a file, and produces parse code.

Examples: http://www.antlr.org/[ANTLR]
